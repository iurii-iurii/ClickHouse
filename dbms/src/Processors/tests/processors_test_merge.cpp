...
try
{
    auto execute_chain = [](ThreadPool * pool)
    {
        ...
        auto source1 = std::make_shared<NumbersSource>(0, 3, 100000);
        auto source2 = std::make_shared<NumbersSource>(1, 3, 100000);
        auto source3 = std::make_shared<NumbersSource>(2, 3, 100000);
